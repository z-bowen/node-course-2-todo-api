...
describe('GET /todos/:id', () => {
  ...
  it('should return 404 when the id of someone elses todo is supplied', (done) => {
    var hexId = todos[0]._id.toHexString();
...
describe('POST /users', () => {
  ...
  it('should return a validation error if the request is invalid', (done) => {
    request(app)
      .post('/users')
      .send({email: 'newUser@test.com', password: ''})
      .expect(400)
      .end(done);
  });
...
describe('DELETE /users/me/token', () => {
  it('should remove the passed x-auth token', (done) => {
    request(app)
